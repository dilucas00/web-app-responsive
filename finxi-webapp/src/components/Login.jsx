        ...
        <div>
            <div className='flex flex-col items-center gap-8'>
                <div className='flex items-center justify-center w-full'>
                    <h4 className='text-white text-2xl font-oswald'>Faça o Login</h4>
                </div>
                ...
                <div className='m-5'>
                    <button onClick={handleHomeClick} className='bg-[#7BDAA5] text-white w-65 h-10 text-sm font-bold shadow-black shadow font-montserrat cursor-pointer hover:scale-105 transition'>Entrar</button>
                </div>
            </div>
